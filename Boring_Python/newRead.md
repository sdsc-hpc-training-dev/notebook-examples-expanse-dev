...
## Environment Modules:
By using <span style="background-color:gray; color:white">Your text here</span>, Boring Python Notebooks, need to install 'pyinputplus' and 'pyperclip' as Python3 does not include the follwing modules.
